  ...
  const onSubmitHandler = async(event)=>{
    ...
    try {
      ...
      if(data.success){
        ...
        setDocImg(false)
        setName('')
        setEmail('doc@gmail.com')
        setPassword('') // docrj123
        setAddress1('')
        setAddress2('')
        setDegree('MBBS')
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            <div className='flex-1 flex flex-col gap-1'>
              <p>Doctor name</p>
              <input onChange={(e)=>setName(e.target.value)} value={name} className='border rounded px-3 py-2' type="text" placeholder="John Doe" required />
            </div>
            <div className='flex-1 flex flex-col gap-1'>
              <p>Email</p>
